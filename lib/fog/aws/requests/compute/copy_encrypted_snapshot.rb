  ...
  module Compute
    class AWS
      class Real
        ...
        def copy_encrypted_snapshot(source_snapshot_id, source_region, encrypted = false, target_region = nil, description = nil)
      ...
      class Mock
        ...
        def copy_encrypted_snapshot(source_snapshot_id, source_region, encrypted = true, target_region, description = nil)
